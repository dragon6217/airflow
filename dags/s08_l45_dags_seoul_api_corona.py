from operators.s08_l45_seoul_api_to_csv_operator import SeoulApiToCsvOperator
import pendulum
from airflow.sdk import DAG


with DAG(
    dag_id='s08_l45_dags_seoul_api_corona',
    schedule='0 7 * * *',
    ...
    tb_corona19_count_status = SeoulApiToCsvOperator(
        ...
        ttteeesssttt_count="_-~^~-_-~^~-_-~^~-_-~^~-_-~^~-_count"
    )
    ...
    tv_corona19_vaccine_stat_new = SeoulApiToCsvOperator(
        ...
        ttteeesssttt_vaccine="_-~^~-_-~^~-_-~^~-_-~^~-_-~^~-_vaccine"
    )
